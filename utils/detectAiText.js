...
/**
 * Mendeteksi apakah teks dihasilkan oleh AI atau manusia
 * @param {string} aiText - Teks yang ingin dianalisis
 * @returns {Promise<Array>} Hasil analisis per kalimat
 */
async function detectAiText(aiText) {
